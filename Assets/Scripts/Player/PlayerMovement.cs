...
/// <summary>
/// This class calculates player movement.
/// This also can be further added to if movement stats
/// are added.
/// </summary>
public class PlayerMovement : MonoBehaviour
{
    public const float DEFAULT_MOVESPEED = 5f;
    public const float RUN_MULTIPLIER = 1.2f;
    ...
    void Move()
    {
        ...
        //    return;
        //}
        float currentSpeed = DEFAULT_MOVESPEED;
        ...
        rb.velocity = movement * currentSpeed;// * player.Stats.moveSpeed;
    }
}
